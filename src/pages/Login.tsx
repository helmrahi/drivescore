        ...
        <div style={{flex:1,display:'flex',alignItems:'center',justifyContent:'center',padding:'32px 20px',background:'white'}}>
          <div style={{width:'100%',maxWidth:400}}>
            <div style={{textAlign:'center',marginBottom:28}}>
              ...
              <div style={{display:'inline-block',marginTop:4,background:WAFA.or,color:WAFA.noir,fontSize:9,fontWeight:800,letterSpacing:'1.2px',padding:'2px 8px',borderRadius:20}}>DRIVESCORE PAYD</div>
            ...
            <div style={{background:'white',borderRadius:20,padding:'28px 24px',boxShadow:'0 4px 24px rgba(0,0,0,0.08)',border:`1px solid ${WAFA.grisMid}`}}>
              ...
              <form onSubmit={handleLogin} style={{display:'flex',flexDirection:'column',gap:18}}>
                ...
                <button type="submit" disabled={loading} style={{
                  ...
                  {loading?(<><div style={{width:18,height:18,border:'2px solid white',borderTopColor:'transparent',borderRadius:'50%',animation:'spin 0.8s linear infinite'}}/>Connexion...</>):'→ Se connecter'}
                </button>
              </form>
            ...
            <p style={{fontSize:11,color:'#94A3B8',margin:'16px 0 0',textAlign:'center',lineHeight:1.6}}>
              Données hébergées en Europe · Conforme CNDP (Loi 09-08)<br/>Agréé par l'ACAPS · © 2026 Wafa Assurance
            </p>
          </div>
        </div>
      </div>
