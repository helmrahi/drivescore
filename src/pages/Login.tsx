...
export default function Login() {
  ...
  return (
    <div style={{ minHeight: '100vh', fontFamily: 'Inter,sans-serif', background: WAFA.gris, display: 'flex' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, paddingTop: 32 }}>
          ...
          <span style={{ color: 'rgba(255,255,255,0.45)', fontSize: 11 }}>Wafa Assurance · Leader de l'assurance au Maroc depuis 1972</span>
        </div>
      </div>

      {/* PANNEAU DROIT — formulaire */}
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px 16px', background: 'white', minHeight: '100vh' }}>
        <div style={{ width: '100%', maxWidth: 400 }}>

          {/* Logo mobile uniquement */}
          <div style={{ textAlign: 'center', marginBottom: 32 }}>
            <img src="/wafa-logo.png" alt="Wafa" style={{ width: 56, height: 56, borderRadius: 12, objectFit: 'cover', marginBottom: 12 }} />
            <div style={{ fontWeight: 900, fontSize: 16, color: WAFA.noir }}>
            ...
            <h2 style={{ fontSize: 26, fontWeight: 900, color: WAFA.noir, margin: '20px 0 4px', letterSpacing: '-0.5px' }}>Connexion</h2>
          ...
          <div style={{ background: 'white', borderRadius: 20, padding: '28px 24px', boxShadow: '0 4px 24px rgba(0,0,0,0.08)', border: `1px solid ${WAFA.grisMid}` }}>
            ...
            <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
              ...
              <div>
                <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: '#6B7280', marginBottom: 8, letterSpacing: '0.5px' }}>
                  ADRESSE EMAIL
                </label>
            ...
            <Link to="/inscription" style={{ textDecoration: 'none' }}>
              <div style={{ padding: '15px', borderRadius: 14, border: `2px solid ${WAFA.or}`, background: WAFA.orLight, textAlign: 'center', color: WAFA.vertDark, fontWeight: 800, fontSize: 14, cursor: 'pointer' }}>
